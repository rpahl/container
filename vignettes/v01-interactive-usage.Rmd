...
is not supported for extraction (it just usually yields `NULL`). As a workaround,
you can always transform to a list first.
...
In addition, non-standard evaluation was added in version 1.1.0, which allows
easy range selection using numbers, unquoted names or both.
