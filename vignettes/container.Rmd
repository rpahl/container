...
This vignette will cover the first point and present the basic container 
operations.
For the second point see
vignette [Why and how container for code development](03-code-development.html).
Examples for specialized data structures are found in the vignettes
[Manage parameter lists with dict](01-parameter-list.html)
and [Smartly select and mutate data columns with dict.table](02-smart-select-and-mutate.html).
