...
output:
  rmarkdown::html_vignette:
    ...
    toc_depth: 4
description: >
  Start here if this is your first time using container.
vignette: >
...
that are best suited for interactive R sessions. To see how to use the
container package for code development, follow the link in 1. and the
respective links in 2. for concrete use cases of derived data structures.
