describe("GroupGenericSummary", {
    ...
    describe("Container", {
        test_that("summary operations work for Container objects", {
            ...
            expect_true(all(container(TRUE, TRUE, T)))
            expect_false(all(container(TRUE, FALSE, T)))
            expect_true(any(container(TRUE, FALSE, T)))
    ...
    describe("Deque", {
        test_that("summary operations work for Deque objects", {
            ...
            expect_true(all(deque(TRUE, TRUE, T)))
            expect_false(all(deque(TRUE, FALSE, T)))
            expect_true(any(deque(TRUE, FALSE, T)))
    ...
    describe("Dict", {
        test_that("summary operations work for Dict objects", {
            ...
            expect_true(all(dict(a = TRUE, b = TRUE, x = T)))
            expect_false(all(dict(a = TRUE, b = FALSE, x = T)))
            expect_true(any(dict(a = TRUE, b = FALSE, x = T)))
    ...
    describe("Set", {
        test_that("summary operations work for Set objects", {
            ...
            expect_true(all(setnew(TRUE, TRUE, T)))
            expect_false(all(setnew(TRUE, FALSE, T)))
            expect_true(any(setnew(TRUE, FALSE, T)))
