...
make life easier when writing **critical** R code and managing
**long** lists. It is based on R's `list` but provides
...
In addition, this package comes with specialized data
...
functions to manage data columns (for more details see
