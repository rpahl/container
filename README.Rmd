...
### Why `container`?
`container` is being developed with the goal to make life easier when working
with R lists, specifically in critical R code.
It extends base R *list* functionality by
